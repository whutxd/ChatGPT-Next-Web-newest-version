  ...
  return (
    ...
    >
      <div className={styles["sidebar-header"]} data-tauri-drag-region>
        ...
        {/* 【已注释】<div className={styles["sidebar-sub-title"]} style={{ color: 'pink', fontWeight: 'bold', fontStyle: 'normal' }}> */}
        <div className={styles["sidebar-sub-title"]} style={{ color: '#FF5A5D', fontWeight: 'normal', fontStyle: 'normal' }}>
          Welcome!<br />
          你好，我是方正电机开发的ChatGPT应用.<br />
          2024.7.15：<br />
          {/* 【已注释】- 备选网址，无需配置，打开即用<br /> */}
          {/* 【已注释】- 免费gpt-3.5网址：free1.fdmgpt.top<br /> */}
          - 付费gpt(需配置key)：<a href="https://fdmgpt.top" target="_blank" style={{ color: 'orange', fontWeight: 'bold', fontStyle: 'italic' }}>fdmgpt.top</a><br />
          - 免费gpt(不需配置key)：<a href="https://free1.fdmgpt.top" target="_blank" style={{ color: 'orange', fontWeight: 'bold', fontStyle: 'italic' }}>free1.fdmgpt.top</a><br />
          2024.7.22：<br />
